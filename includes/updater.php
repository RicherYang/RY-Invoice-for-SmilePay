...
final class RY_IFSMILEPAY_Updater
{
    protected static ?self $_instance = null;

    public static function instance(): RY_IFSMILEPAY_Updater
    {
    ...
    public function update_plugin($update, $plugin_data)
    {
        ...
        return RY_IFSMILEPAY_LinkServer::instance()->check_version();
    }
    ...
    public static function modify_plugin_details($result, $action, $args)
    {
        ...
        if ($args->slug !== 'ry-invoice-for-smilepay') {
            return $result;
        }

        $response = RY_IFSMILEPAY_LinkServer::instance()->get_info();
        if (!empty($response)) {
