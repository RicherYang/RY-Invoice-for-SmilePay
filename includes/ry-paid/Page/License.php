...
final class License extends AbstractAdminPage
{
    ...
    protected function do_init(): void
    {
        ...
        foreach ($this->license_list as $key => $license) {
            ...
            if (!$license['license'] instanceof AbstractLicense) {
                unset($this->license_list[$key]);
                continue;
            }
        }
    ...
    public function output_page(): void
    {
        ...
        Utils::the_action_form_button('paid-license', 'save-option', __('Save Changes', 'ry-invoice-for-smilepay'), 'submit', 'button-primary');
        echo '</form>';
