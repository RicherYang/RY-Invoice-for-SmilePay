...
<h2 class="title"><?php esc_html_e('Buyer options', 'ry-invoice-for-smilepay'); ?></h2>
<table class="form-table" role="presentation">
    <tr>
        <th scope="row"><?php esc_html_e('Buyer name', 'ry-invoice-for-smilepay'); ?></th>
        <td>
            <fieldset>
                <legend class="screen-reader-text"><span><?php esc_html_e('Use real name', 'ry-invoice-for-smilepay'); ?></span></legend>
                <label for="buyer_name"><input name="buyer_name" type="checkbox" id="buyer_name" value="yes" <?php checked($general_info['buyer']['name']); ?>>
                    <?php esc_html_e('Use real name', 'ry-invoice-for-smilepay'); ?></label>
                <p class="description">
                    <?php echo esc_html(sprintf(__('If disabled, fallback to "%s" as the name.', 'ry-invoice-for-smilepay'), __('Customer', 'ry-invoice-for-smilepay'))); ?>
                    <?php esc_html_e('Only for personal invoice.', 'ry-invoice-for-smilepay'); ?>
                </p>
            </fieldset>
        </td>
    </tr>
    <tr>
        <th scope="row"><?php esc_html_e('Buyer address', 'ry-invoice-for-smilepay'); ?></th>
        <td>
            <fieldset>
                <legend class="screen-reader-text"><span><?php esc_html_e('Use real address', 'ry-invoice-for-smilepay'); ?></span></legend>
                <label for="buyer_address"><input name="buyer_address" type="checkbox" id="buyer_address" value="yes" <?php checked($general_info['buyer']['address']); ?>>
                    <?php esc_html_e('Use real address', 'ry-invoice-for-smilepay'); ?></label>
                <p class="description">
                    <?php echo esc_html(sprintf(__('If disabled, fallback to "%s" as the address.', 'ry-invoice-for-smilepay'), __('Taiwan', 'ry-invoice-for-smilepay'))); ?>
                </p>
            </fieldset>
        </td>
    </tr>
...
<table class="form-table" role="presentation">
    ...
    <tr>
        <th scope="row"><label for="donate"><?php esc_html_e('Default donate number', 'ry-invoice-for-smilepay'); ?></label></th>
        <td>
            ...
            <p class="description">
                <?php echo wp_kses(
                    sprintf(
                        ...
                        __('Separate donate numbers with commas. View <a href="%s" target="_blank">full list</a>.', 'ry-invoice-for-smilepay'),
